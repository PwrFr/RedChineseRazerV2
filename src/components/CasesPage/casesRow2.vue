  ...
  <div>
    <div class="row cases-full-row2">
      ...
      <div class="col cases-row2-text" style="padding-left: 90px;">
        ...
        <div
          class="row cases-row2-des"
        >For those who constantly seek to push the power of their PC, this mid-tower ATX gaming case with built-in cable management offers ample room for expandability to open up a whole host of performance options.</div>
      </div>
    </div>
  </div>
</template>
