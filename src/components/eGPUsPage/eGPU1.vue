<template>
  <section>
    <div
      class="quotes quotesWithIcon text-center container-center ng-star-inserted"
      style="
        padding: 40px 20px;
            ...
            <div class="quote_container">
              <div>
                <a
                  ...
                  href="https://egpu.io/razer-core-x-review-thick-juicy/"
                  target="_blank"
                  data-gtm-promotion-viewed="true"
                >
                  <img src="@/assets/products/2eGPUs/1.png" alt="" />
                </a>
              </div>
              <h2
                class="content_text_1 ng-star-inserted boos-h2"
                markdown=""
              ...
              <p class="content_text_2 ng-star-inserted">
                <a
                  ...
                  href="https://egpu.io/razer-core-x-review-thick-juicy/"
                  target="_blank"
                  style="color: rgb(136, 136, 136); font-size: 24px"
                  data-gtm-promotion-viewed="true"
                >
                  <ul class="boos-ul">
                    <li style="text-align: center; padding-top: 4px">
                      <em class="boos-em">eGPU.io</em>
                    </li>
                  </ul>
                </a>
              </p>
