<template>
  <section>
    ...
    <imgCol
      ...
      bgImgCR="4R.jpg"
      titleCR="Cyberpunk 2077 Edition"
    ...
    <imgCol
      ...
      bgImgCR="6R.jpg"
      titleCR="JOIN THE DISCUSSION ON ALL THINGS RAZER"
      discriptionCR="Get in on Razer Insider"
    />
  </section>
</template>
<script>
const imageRow = () => import("@/components/ImageRow");
const imgCol = () => import("@/components/imgCol");
